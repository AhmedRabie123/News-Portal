                                ...
                                <div class="col-xl-9 col-lg-9 col-md-8 col-sm-12">
                                    <div class="tab-content" id="v-pills-tabContent">
                                        ...
                                        <div class="pt_0 tab-pane fade" id="v-5" role="tabpanel"
                                            ...
                                            <div class="form-group mb-3">
                                                <label>Google Analytic Code (ID) *</label>
                                        ...
                                        <div class="pt_0 tab-pane fade" id="v-6" role="tabpanel"
                                            ...
                                            <div class="form-group mb-3">
                                                <label>Disqus Code (ID) *</label>
                                                <textarea name="disqus_code" class="form-control " cols="30" rows="10" style="height: 300px;">{{ $setting_data->disqus_code }}</textarea>
                                            </div>
                                            <!-- Disqus End -->
                                        </div>
