    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ Request::is('admin/category-*') || Request::is('admin/sub-category-*') || Request::is('admin/post-*') ? 'active' : '' }} ">
                ...
                <ul class="dropdown-menu">
                    <li class="{{ Request::is('admin/category-*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_category_show') }}"><i
                                class="fas fa-angle-right"></i> Categories
                        </a></li>
                    <li class="{{ Request::is('admin/sub-category-*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_sub_category_show') }}"><i
                                class="fas fa-angle-right"></i>SubCategories
                        </a></li>
                    <li class="{{ Request::is('admin/post-*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_post_show') }}"><i
                                class="fas fa-angle-right"></i>Posts
                        </a></li>
