...
{
    public function author_post_show()
    {
    ...
    public function author_post_create()
    {
    ...
    public  function author_post_store(Request $request)
    {
    ...
    public function author_post_edit($id)
    {
    ...
    public function author_post_update(Request $request, $id)
    {
        $request->validate([
            'post_title' => 'required|',
            'post_detail' => 'required|',
        ...
        return redirect()->route('author_post_show')->with('success', 'Post Updated Successfully.');
    }

    public function author_tag_delete($id, $id1)
    {
    ...
    public function author_post_delete($id)
    {
